...
typedef enum BlockdevDriver {
    ...
    BLOCKDEV_DRIVER_NULL_AIO = 15,
    BLOCKDEV_DRIVER_NULL_CO = 16,
    BLOCKDEV_DRIVER_PARALLELS = 17,
    BLOCKDEV_DRIVER_QCOW = 18,
    BLOCKDEV_DRIVER_QCOW2 = 19,
    BLOCKDEV_DRIVER_QED = 20,
    BLOCKDEV_DRIVER_QUORUM = 21,
    BLOCKDEV_DRIVER_RAW = 22,
    BLOCKDEV_DRIVER_TFTP = 23,
    BLOCKDEV_DRIVER_VDI = 24,
    BLOCKDEV_DRIVER_VHDX = 25,
    BLOCKDEV_DRIVER_VMDK = 26,
    BLOCKDEV_DRIVER_VPC = 27,
    BLOCKDEV_DRIVER_VVFAT = 28,
    BLOCKDEV_DRIVER__MAX = 29,
} BlockdevDriver;
