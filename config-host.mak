...
libs_softmmu=-L$(BUILD_DIR)/pixman/pixman/.libs -lpixman-1 -lutil  -lSDL -lX11  -L$(BUILD_DIR)/dtc/libfdt -lfdt
ARCH=x86_64
STRIP=strip
CONFIG_POSIX=y
CONFIG_LINUX=y
...
VERSION=2.7.0
PKGVERSION=
SRC_PATH=/home/sonny/qemu_eclipse
TARGET_DIRS=x86_64-softmmu x86_64-linux-user i386-linux-user
CONFIG_SDL=y
CONFIG_SDLABI=1.2
...
QEMU_INCLUDES=-I$(SRC_PATH)/tcg -I$(SRC_PATH)/tcg/i386 -I$(SRC_PATH)/linux-headers -I/home/sonny/qemu_eclipse/linux-headers -I. -I$(SRC_PATH) -I$(SRC_PATH)/include
AUTOCONF_HOST := 
